									...
									ListHeaderComponent={
										showUnlinkOption ? (
											...
											>
												...
												<ThemedText style={{color: '#EF4444', fontWeight: '600'}}>Desvincular
													Psicólogo</ThemedText>
											</TouchableOpacity>
										) : null
									}
									renderItem={({item}) => (
										...
										>
											...
											<View style={styles.info}>
												...
												<ThemedText
													style={[styles.crp, {color: mutedColor}]}>CRP: {item.crp}</ThemedText>
											</View>
